...
>
  ...
  >
    <!-- Sidebar Menu -->
    <nav x-data="{selected: 'Dashboard', subSelected: ''}">
      <!-- Menu Group -->
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-1">
          ...
          <li>
            ...
            >
              ...
              >
                <path
                  d="M5 10.0002L15.0006 10.0002M10.0002 5L10.0002 15.0006"
                  stroke="currentColor"
                  stroke-width="1.5"
            ...
            >
              ...
              >
                ...
                <li>
                  <a
                    href="#"
                    @click.prevent="subSelected = (subSelected === 'CRM' ? '' : 'CRM')"
                  ...
                  <div
                    class="translate transform overflow-hidden"
                    :class="subSelected === 'CRM' ? 'block' : 'hidden'"
                  >
                    <ul
                    ...
                    >
                      ...
                      <li>
                        <a
                          href="#"
                          class="menu-dropdown-item group"
                          :class="page === 'crmProductDev' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                        >
                          Product Development
                        </a>
                      </li>
                      <li>
                        <a
                          href="#"
                          class="menu-dropdown-item group"
                          :class="page === 'crmFinance' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                        >
                          Finance
                        </a>
                      </li>
                      <li>
                        <a
                          href="#"
                          class="menu-dropdown-item group"
                          :class="page === 'crmHR' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                        >
                          Human Resources
                        </a>
                      </li>
                      <li>
                        <a
                          href="#"
                          class="menu-dropdown-item group"
                          :class="page === 'crmSupplyChain' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                        >
                          Supply Chain
                        </a>
                      </li>
                ...
                <li>
                  <a
                    href="#"
                    class="menu-dropdown-item group"
                    :class="page === 'ai' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                  >
                    AI
                  </a>
                </li>
            ...
            >
              ...
              >
                ...
                <li>
                  <a
                    href="#"
                    @click.prevent="subSelected = (subSelected === 'Invoices' ? '' : 'Invoices')"
                    class="menu-dropdown-item group flex items-center justify-between"
                    :class="(page === 'invoices' || page === 'singleInvoice' || page === 'createInvoice') ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                  >
                    Invoices
                    <svg
                      x-show="subSelected !== 'Invoices'"
                      width="16"
                      height="16"
                      viewBox="0 0 20 20"
                      fill="none"
                  ...
                  <div
                    class="translate transform overflow-hidden"
                    :class="subSelected === 'Invoices' ? 'block' : 'hidden'"
                  >
                    <ul
                      class="mt-2 flex flex-col gap-1 border-l border-gray-200 pl-4 dark:border-gray-800"
                    >
            ...
            >
              ...
              >
                ...
                <li>
                  <a
                    href="#"
                    @click.prevent="subSelected = (subSelected === 'ErrorPages' ? '' : 'ErrorPages')"
                    class="menu-dropdown-item group flex items-center justify-between"
                    :class="(page === 'page404' || page === 'page500' || page === 'page503') ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                  >
                    Error Pages
                    <svg
                      x-show="subSelected !== 'ErrorPages'"
                      width="16"
                      height="16"
                      viewBox="0 0 20 20"
                      fill="none"
                  ...
                  <div
                    class="translate transform overflow-hidden"
                    :class="subSelected === 'ErrorPages' ? 'block' : 'hidden'"
                  >
                    <ul
                      class="mt-2 flex flex-col gap-1 border-l border-gray-200 pl-4 dark:border-gray-800"
                    >
    ...
    <!-- Promo Box -->
      ...
      <!-- ===== Content Area Start ===== -->
      <div
        class="relative flex flex-1 flex-col overflow-x-hidden overflow-y-auto bg-white dark:bg-gray-900"
      >
      ...
      >
        ...
        >
          <div>
            ...
            >
              <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0e7c6f606a61637b7d6b7c4e7e67636461206d6163">[email&#160;protected]</a>
            </span>
          </div>
...
<!-- ===== Header End ===== -->
        ...
        <main>
          ...
          >
            <div class="space-y-6">
              <div
                class="grid auto-rows-min gap-6 sm:grid-cols-2 xl:grid-cols-4"
              >
                <div
                  class="h-40 rounded-xl border border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-white/3"
                ></div>
                <div
                  class="h-40 rounded-xl border border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-white/3"
                ></div>
              ...
              <div
                class="grid auto-rows-min gap-6 sm:grid-cols-2 xl:grid-cols-3"
              >
                <div
                  class="col-span-2 min-h-dvh rounded-xl border border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-white/3"
                ></div>
                <div
                  class="col-span-1 min-h-dvh rounded-xl border border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-white/3"
                ></div>
              </div>
            </div>
          </div>
